...
const SideBar = () => {
  ...
  return (
    <div className="hidden  col-span-2 row-span-full  md:flex items-start justify-start gap-3 flex-col max-h-screen min-h-screen overflow-auto  text-white bg-secondary-800 p-5">
