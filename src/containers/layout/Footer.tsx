        ...
        <section className=" min-w-full min-h-fit flex  flex-wrap items-start justify-center pb-10 gap-3">
          <section className=" flex flex-col items-start justify-start gap-3 w-full md:min-w-[25%] md:max-w-[25%]    ">
            <div>
              ...
              <p className="text-[.8rem] font-light max-w-[80%]">
                Game-Hub یک مقصد آنلاین پیشرو برای همه نیازهای بازی، رایانه
                شخصی، لپ تاپ، پیوست های فنی و فیلم شما است. با انتخاب گسترده ای
                از جدیدترین بازی ها، فناوری پیشرفته و خدمات مشتری درجه یک، ما در
                تلاش هستیم تا بهترین تجربه خرید را برای گیمرها و علاقه مندان به
                فناوری فراهم کنیم. تعهد ما به ارائه بهترین محصولات، قیمت های
                رقابتی و تحویل قابل اعتماد ما را به نامی قابل اعتماد در صنعت
                تبدیل کرده است. امروز به جامعه بازی ما بپیوندید و امکانات بی
                پایانی را که Game-Hub ارائه می دهد کشف کنید.
              </p>
            </div>
          ...
          <section className="  flex flex-col items-start justify-start gap-3 w-full md:min-w-[25%] md:max-w-[25%]  ">
            ...
            <p className="text-[.8rem] font-light max-w-[80%]">
              ...
              معاملات انحصاری و نسخه‌های جدید را از دست ندهید. اولین کسی باشید
              که در مورد نسخه های بازی های آینده، داغ ترین ابزارهای فناوری و
              تبلیغات هیجان انگیز مطلع می شوید. خبرنامه ما محتوای انتخاب شده را
              مستقیماً به صندوق ورودی شما ارائه می دهد و شما را مطلع و سرگرم نگه
              می دارد. چه یک خبره بازی باشید و چه از علاقه مندان به فناوری،
              عضویت در خبرنامه ما تضمین می کند که همیشه از آخرین روندها و نوآوری
              ها در دنیای بازی و فناوری به روز هستید. اکنون ثبت نام کنید و تجربه
              بازی خود را با Game-Hub ارتقا دهید!
            </p>
            <Normal_textfield
